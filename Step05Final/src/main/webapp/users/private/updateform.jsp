...
<body>
	...
	<script>
		...
		document.querySelector("#profileLink").addEventListener("click",()=>{
			//input type="file" 요소를 강제 클릭해서 파일선택창이 뜨도록 함 
		...
		document.querySelector("#image").addEventListener("change", ()=>{
			...
			//my_util에 있는 함수를 이용해서 ajax 전송
			ajaxFormPromise(form)
			.then(res=>res.json())
			.then((data)=>{
				//data는 {imagePath:"upload/xxx.jpg"}형식의 object임
				console.log(data);
				//input name="profile"요소의 value값으로 이미지 경로 넣어줌
